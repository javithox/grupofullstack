...
import com.ignacio.msvccompras.DTO.ErrorDTO;
...
public class GlobalException {
    ...
    public ResponseEntity<ErrorDTO> handlePrevisionException(CompraException exception) {
        ...
        if (exception.getMessage().contains("no se encuentra en la base de datos")) {
            ...
            Map<String, String> errorMap = Collections.singletonMap("Compra no encontrada", exception.getMessage());
            ...
            Map<String, String> errorMap = Collections.singletonMap("Compra existente", exception.getMessage());
