...
import com.grupofullstack.msvc.gestionEnvios.msvc.DTO.ErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handlePrevisionException(EnvioException exception){
        ...
        if(exception.getMessage().contains("no se encuentra en la base de datos")) {
            ...
            Map<String, String> errorMap = Collections.singletonMap("Envio no encontrado", exception.getMessage());
            ...
            Map<String, String> errorMap = Collections.singletonMap("Envio existente", exception.getMessage());
