package com.fullStack.msvc.gestionUsuario.msvc.exceptions;

import com.fullStack.msvc.gestionUsuario.msvc.DTO.ErrorDTO;
...
public class GlobalException {
    ...
    public ResponseEntity<ErrorDTO> handlePrevisionException(UsuarioException exception){
