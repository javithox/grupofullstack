package com.fullStack.msvc.msvc_empleados.exceptions;

import com.fullStack.msvc.msvc_empleados.DTO.ErrorDTO;
...
public class GlobalException {
    ...
    public ResponseEntity<ErrorDTO> handlePrevisionException(EmpleadoException exception){
        ...
        if(exception.getMessage().contains("no se encuentra en la base de datos")) {
            ...
            Map<String, String> errorMap = Collections.singletonMap("Empleado no encontrado", exception.getMessage());
            ...
            Map<String, String> errorMap = Collections.singletonMap("Empleado existente", exception.getMessage());
